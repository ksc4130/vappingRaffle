/*
 ...
 Version 0.2.2
 */
(function(c){"function"===typeof define&&define.amd?define(["knockout"],c):c(ko)})(function(c){function f(a,b){return p(v(a),"preprocess",b)}function v(a){return"object"===typeof a?a:c.getBindingHandler(a)||(c.bindingHandlers[a]={})}function p(a,b,d){if(a[b]){var e=a[b];a[b]=function(a,b,c){if(a=e.call(this,a,b,c))return d.call(this,a,b,c)}}else a[b]=d;return a}function x(a){var b=c.bindingProvider.instance;if(b.preprocessNode){var d=b.preprocessNode;b.preprocessNode=function(b){var c=d.call(this,
    b);c||(c=a.call(this,b));return c}}else b.preprocessNode=a}function y(a,b){var d=c.getBindingHandler;c.getBindingHandler=function(e){var c;return d(e)||(c=e.match(a))&&b(c,e)}}function r(a){if(-1===a.indexOf("|"))return a;var b=a.match(/"([^"\\]|\\.)*"|'([^'\\]|\\.)*'|\|\||[|:]|[^\s|:"'][^|:"']*[^\s|:"']|[^\s|:"']/g);if(b&&1<b.length){b.push("|");a=b[0];for(var d,e,c=!1,q=!1,w=1;e=b[w];++w)"|"===e?(c&&(":"===d&&(a+="undefined"),a+=")"),c=q=!0):(q?a="ko.filters['"+e+"']("+a:c&&":"===e?(":"===d&&(a+=
    "undefined"),a+=","):a+=e,q=!1),d=e}return a}function z(a){f(a,r)}function s(a,b,d){function e(d){g[d]&&(g[d]=function(e,g){var f=Array.prototype.slice.call(arguments,0);f[1]=function(){var b={};b[a]=g();return b};return c.bindingHandlers[b][d].apply(this,f)})}var g=c.utils.extend({},this);e("init");e("update");g.preprocess&&(g.preprocess=null);c.virtualElements.allowedBindings[b]&&(c.virtualElements.allowedBindings[d]=!0);return g}function t(a,b){var d=c.getBindingHandler(a);if(d){var e=d.getNamespacedHandler||
    s;d.getNamespacedHandler=function(){return f(e.apply(this,arguments),b)}}}function A(a,b,d){if("{"!==a.charAt(0))return a;a=c.expressionRewriting.parseObjectLiteral(a);c.utils.arrayForEach(a,function(a){d(b+B+a.key,a.value)})}function l(a){f(a,A)}function k(a){return/^([$_a-z][$\w]*|.+(\.\s*[$_a-z][$\w]*|\[.+\]))$/i.test(a)?"function(_x,_y,_z){return("+a+")(_x,_y,_z);}":a}function m(a){f(a,k)}function n(a,b,d){a=v(a);a._propertyPreprocessors||(p(a,"preprocess",F),a._propertyPreprocessors={});p(a._propertyPreprocessors,
    b,d)}function F(a,b,d){if("{"!==a.charAt(0))return a;a=c.expressionRewriting.parseObjectLiteral(a);var e=[],g=this._propertyPreprocessors||{};c.utils.arrayForEach(a,function(a){var b=a.key;a=a.value;g[b]&&(a=g[b](a,b,d));a&&e.push("'"+b+"':"+a)});return"{"+e.join(",")+"}"}function u(a){return function(b){return"function("+a+"){return("+b+");}"}}function C(a){if(3===a.nodeType&&a.nodeValue&&-1!==a.nodeValue.indexOf("{{")){var b=[],d=function(a){a&&b.push(document.createTextNode(a))},c=function(a){b.push.apply(b,
